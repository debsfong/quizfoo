...
Question.create!(text: "What?", form_type: "MC", order: 1, quiz_id: 1)
Question.create!(text: "Where?", form_type: "MC", order: 1, quiz_id: 1)
Question.create!(text: "1+1", form_type: "MC", order: 1, quiz_id: 2)
Question.create!(text: "1+2", form_type: "MC", order: 1, quiz_id: 2)
Question.create!(text: "1-1", form_type: "MC", order: 1, quiz_id: 3)
Question.create!(text: "1-2", form_type: "MC", order: 1, quiz_id: 3)
